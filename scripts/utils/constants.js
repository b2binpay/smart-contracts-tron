...
// Permission bits: the base declares claim, `MultiSigWalletStaking` allocates its own above
// `BASE_PERMISSION_MASK`
const PERMISSION_CLAIM = 1n << 0n;
const BASE_PERMISSION_MASK = (1n << 128n) - 1n;
const PERMISSION_DELEGATE = 1n << 128n;
const PERMISSION_UNDELEGATE = 1n << 129n;
const EXTENSION_PERMISSIONS = PERMISSION_DELEGATE | PERMISSION_UNDELEGATE;
const SUPPORTED_PERMISSIONS = PERMISSION_CLAIM | EXTENSION_PERMISSIONS;
